...
def RecreateTable(request):
    ...
    api_DataGeneration.api_user_table("Abnormal_transfer")
    api_DataGeneration.api_store_table("Abnormal_transfer")
    api_DataGeneration.api_card_table("Abnormal_transfer")
    api_DataGeneration.api_trans_table("Abnormal_transfer")
...
def do_zip_compress(dirpath):
    ...
    output_name = f"{dirpath}Abnormal_transfer.zip"
    print(output_name)
...
def download(request):
    ...
    print(path)
    api_DataGeneration.api_export_to_csv("Abnormal_transfer", path)

    print("Start packing data")
    do_zip_compress(path)

    print('Start downloading data')
    file_path = path + r'Abnormal_transfer.zip'
    try:
