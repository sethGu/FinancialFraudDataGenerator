...
def RecreateTable(request):
    ...
    print("重建表开始")
    api_DataGeneration.api_user_table("商户违规")
    api_DataGeneration.api_store_table("商户违规")
    api_DataGeneration.api_card_table("商户违规")
    api_DataGeneration.api_trans_table("商户违规")
    print("重建表结束")
...
def do_zip_compress(dirpath):
    ...
    output_name = f"{dirpath}商户违规.zip"
    print(output_name)
...
def download(request):
    ...
    print(path)
    api_DataGeneration.api_export_to_csv("商户违规", path)
