...
def consumption(request):
    ...
    api_DataGeneration.api_consumption("Fake_registration", year, month, day, duration)
...
def consumptionDisplay():
    consumption_num = RegisterTrans.objects.filter(abnormal=0, t2='01').count()
...
def transfer(request):
    ...
    api_DataGeneration.api_relative("Fake_registration", year, month, day, duration)
...
def transferDisplay():
    transfer_num = RegisterTrans.objects.filter(abnormal=0, t2='03').count()
