...
from app01.models import RegisterUser, RegisterStore, RegisterCard
...
def user(request):
    ...
    api_DataGeneration.api_user("Fake_registration", total)
...
def userDisplay():
    ...
    user_number = RegisterUser.objects.count()
...
def store(request):
    ...
    api_DataGeneration.api_store("Fake_registration", total)
...
def storeDisplay():
    stores = RegisterStore.objects.all()
    stores_number = RegisterStore.objects.count()
...
def card(request):
    ...
    api_DataGeneration.api_card("Fake_registration")
...
def cardDisplay():
    cards = RegisterCard.objects.all()
