...
from app01.models import CreditUser, CreditStore, CreditCard
...
def userDisplay():
    users = CreditUser.objects.all()
    user_number = CreditUser.objects.count()
...
def storeDisplay():
    stores = CreditStore.objects.all()
    stores_number = CreditStore.objects.count()
