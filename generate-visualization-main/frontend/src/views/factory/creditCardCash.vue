<template>
  <div class="app-container">
    <div class="credit-header">
      <el-form id="creditAllForm" ref="form" :inline="true" :model="form" :rules="rules" label-width="200px">
        <div class="shortLong" />
        ...
        <el-form-item id="shortTime" label="Short-term interval(hours)">
          <el-input-number v-model="form.shortTime" controls-position="right" :min="1" :max="20"/>
        </el-form-item>
<!--        </div>-->
        ...
        <el-form-item label="Violative merchants count">
          <el-input-number v-model="form.store" :min="10" label="Description text"/>
        </el-form-item>
        ...
        <el-form-item label="Operating hours ratio">  <!--is_in_opening_time-->
          <el-input-number v-model="form.openTime" :precision="1" :step="0.1" :min="0.1" :max="1.0"
                           controls-position="right"/>
        </el-form-item>

        <el-form-item label="Individual merchant ratio">
          <el-input-number v-model="form.storeRatio" :precision="1" :step="0.1" :min="0.1" :max="1.0"/>
        </el-form-item>
        <el-form-item label="Merchant max grouping">
          <el-input-number v-model="form.storeMax" controls-position="right" :min="10"/>
        </el-form-item>
        ...
        <el-form-item label="Select time" class="storefraud" prop="startDate">
          <el-date-picker
...
export default {
  ...
  beforeCreate() {
    this.$store.dispatch('creditCardCash/durationSetCredit').then(() => {
      this.form.startDate = this.$store.state.creditCardCash.credit_date_data.startDate
      this.form.duration = this.$store.state.creditCardCash.credit_date_data.duration
    })
  },
  created() {
    this.init()
  ...
  methods: {
    ...
    dispatchCon() {
      if (this.is_con) {
        ...
        return this.$store.dispatch('creditCardCash/consumeGenerateCredit', {
          date: this.form.startDate,
          duration: this.form.duration
        })
      } else {
        console.log('consumeInit')
        return this.$store.dispatch('creditCardCash/consumeInitCredit', {
          date: this.form.startDate,
          duration: this.form.duration
        })
      }
    ...
    dispatchTran() {
      if (this.is_tran) {
        ...
        return this.$store.dispatch('creditCardCash/transferGenerateCredit', {
          date: this.form.startDate,
          duration: this.form.duration
        })
      } else {
        console.log('transferInit')
        return this.$store.dispatch('creditCardCash/transferInitCredit', {
          date: this.form.startDate,
          duration: this.form.duration
        })
      }
    ...
    reset() {
      ...
      this.form.shortTime = 1
      this.form.longTime = 20
      this.form.user = 10
      this.form.store = 10
      this.form.duration = 30
      this.form.personalRatio = 0.7
    ...
    init() {
      this.$store.dispatch('creditCardCash/userInitCredit', this.userAmount).then(() => {
        ...
        this.$store.dispatch('creditCardCash/storeInitCredit', this.storeAmount).then(() => {
          ...
          this.$confirm('Do you want to generate the data?', 'Tip', {
            ...
            this.$store.dispatch('creditCardCash/durationChooseCredit', {startDate: this.form.startDate, duration: this.form.duration}).then(() => {
              this.$store.dispatch('creditCardCash/userGenerateCredit', this.userAmount).then(() => {
                ...
                this.$store.dispatch('creditCardCash/storeGenerateCredit', this.storeAmount).then(() => {
                  loadingInstanceStoreBig.close()
                  this.showChartStoreBig()

                  this.$store.dispatch('creditCardCash/cardGenerateCredit', '1').then(() => {
                    ...
                    this.dispatchCon().then(() => {
                      ...
                      this.dispatchTran().then(() => {
                        ...
                        this.showChartConsume()
                        // 公共
                        this.$store.dispatch('creditCardCash/creditGenerate', this.form).then(response => {
                          loadingInstanceCredit.close()
                          this.showChartCreditCardCash()
        ...
        xAxis: [
          {
            ...
            data: this.credit_user_data['user_age_data_1'],
            axisTick: {
              alignWithLabel: true
            }
          }
        ...
        series: [
          {
            ...
            data: this.credit_user_data['user_age_data_2']
          }
        ]
      }
    ...
    showChartConsume() {
      ...
      var optionConsume = {
        ...
        xAxis: {
          ...
          data: this.credit_consume_data['trans_time']
        },
        yAxis: {
          type: 'value',
          name: 'Amount (CNY)'
        ...
        series: [
          {
            ...
            data: this.credit_consume_data['trans_amount']
          }
        ]
      }
    ...
    showChartFraud() {
      ...
      var optionFraud = {
        ...
        xAxis: {
          ...
          // data: ['20151212', '20161212', '20181212', '20191212', '20201212', '20211212', '20221212']
          data: this.credit_data['data_2']['trans_time']
        },
        yAxis: {
          type: 'value',
          name: 'Amount (CNY)'
        ...
        series: [
          {
            ...
            stack: 'Total',
            // data: [120, 132, 101, 134, 90, 230, 210]
            data: this.credit_data['data_2']['trans_amount']
          }
        ]
      }
    ...
    //         data: this.credit_user_data['user_job_data']
    //       }
    //     ]
    //   }
    ...
    //       },
    //       // data: ['20151212', '20161212', '20181212', '20191212', '20201212', '20211212', '20221212']
    //       data: this.credit_transfer_data['trans_time']
    //     },
    //     yAxis: {
    //       type: 'value',
    //       name: 'Amount (CNY)'
    ...
    //         stack: 'Total',
    //         // data: [120, 132, 101, 134, 90, 230, 210]
    //         data: this.credit_transfer_data['trans_amount']
    //       }
    //     ]
    //   }
