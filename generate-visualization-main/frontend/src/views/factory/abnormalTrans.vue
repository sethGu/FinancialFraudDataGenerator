...
export default {
  ...
  beforeCreate() {
    this.$store.dispatch('abnormalTrans/durationSetAbnormal').then(() => {
      this.form.startDate = this.$store.state.abnormalTrans.abnormal_date_data.startDate
      this.form.duration = this.$store.state.abnormalTrans.abnormal_date_data.duration
    })
  },
  created() {
    this.init()
  ...
  methods: {
    ...
    dispatchCon() {
      if (this.is_con) {
        ...
        return this.$store.dispatch('abnormalTrans/consumeGenerateAbnormal', { date: this.form.startDate, duration: this.form.duration })
      } else {
        console.log('consumeInit')
        return this.$store.dispatch('abnormalTrans/consumeInitAbnormal', { date: this.form.startDate, duration: this.form.duration })
      }
    },
    dispatchTran() {
      if (this.is_tran) {
        console.log('transferGenerate')
        return this.$store.dispatch('abnormalTrans/transferGenerateAbnormal', { date: this.form.startDate, duration: this.form.duration })
      } else {
        console.log('transferInit')
        return this.$store.dispatch('abnormalTrans/transferInitAbnormal', { date: this.form.startDate, duration: this.form.duration })
      }
    },
    reset() {
      this.userAmount = 50
    ...
    init() {
      this.$store.dispatch('abnormalTrans/userInitAbnormal', this.userAmount).then(() => {
        ...
        this.$store.dispatch('abnormalTrans/storeInitAbnormal', this.storeAmount).then(() => {
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          this.$confirm('Do you want to generate the data?', 'Tip', {
            ...
            this.$store.dispatch('abnormalTrans/durationChooseAbnormal',
              { startDate: this.form.startDate, duration: this.form.duration }).then(() => {
              console.log(this.form.startDate)
              this.$store.dispatch('abnormalTrans/userGenerateAbnormal', this.userAmount).then(() => {
                loadingInstanceUserAge.close()
                // loadingInstanceUserJob.close()
                this.showUserAge()
                // this.showUserJob()

                this.$store.dispatch('abnormalTrans/storeGenerateAbnormal', this.storeAmount).then(() => {
                  loadingInstanceStoreBig.close()
                  this.showChartStoreBig()

                  this.$store.dispatch('abnormalTrans/cardGenerateAbnormal', '1').then(() => {
        ...
        xAxis: [
          {
            ...
            data: this.abnormal_user_data['user_age_data_1'],
            axisTick: {
              alignWithLabel: true
            }
          }
        ...
        series: [
          {
            ...
            data: this.abnormal_user_data['user_age_data_2']
          }
        ]
      }
    ...
    showChartCard() {
      ...
      this.abnormal_card_data.forEach(item => {
        var objTmp = {
          value: item.value,
          name: item.name
        }
        ...
        series: [
          {
            ...
            data: this.abnormal_data['data_1']
          }
        ]
      }
      this.chart.setOption(optionAbnormalTrans)
    },
    // showChartConsume() {
    ...
    //       data: this.abnormal_consume_data['trans_time']
    //     },
    //     yAxis: {
    //       type: 'value',
    //       name: 'Amount (CNY)'
    ...
    //         data: this.abnormal_consume_data['trans_amount']
    //       }
    //     ]
    //   }
    ...
    showChartFraud() {
      ...
      var optionFraud = {
        ...
        xAxis: {
          ...
          // data: ['20151212', '20161212', '20181212', '20191212', '20201212', '20211212', '20221212']
          data: this.abnormal_data['data_2']['trans_time']
        },
        yAxis: {
          type: 'value',
          name: 'Amount (CNY)'
        ...
        series: [
          {
            ...
            stack: 'Total',
            // data: [120, 132, 101, 134, 90, 230, 210]
            data: this.abnormal_data['data_2']['trans_amount']
          }
        ]
      }
    ...
    //         data: this.abnormal_user_data['user_job_data']
    //       }
    //     ]
    //   }
    ...
    showChartTrans() {
      ...
      var optionTrans = {
        ...
        xAxis: {
          ...
          // data: ['20151212', '20161212', '20181212', '20191212', '20201212', '20211212', '20221212']
          data: this.abnormal_transfer_data['trans_time']
        },
        yAxis: {
          type: 'value',
          name: 'Amount (CNY)'
        ...
        series: [
          {
            ...
            stack: 'Total',
            // data: [120, 132, 101, 134, 90, 230, 210]
            data: this.abnormal_transfer_data['trans_amount']
          }
        ]
      }
